...
ggplot(datosBarrios) +
  aes(x = num_max_pers_duermen_por_dormitorio, y = promedio_personas_por_habitacion) +
  geom_point() +
  labs(x = "Número máximo de personas que duermen por dormitorio", y = "Número de ambientes usados como dormitorio") +
  ggtitle("Relación entre número de integrantes y número de ambientes de dormitorio") +
  theme_classic()
