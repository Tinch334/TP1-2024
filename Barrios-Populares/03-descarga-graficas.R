...
## Formato: png
## Asegurarse de haber corrido ingesta-barrios.R, manipulacion_barrios.R y graficas-barrios.R

ggsave("Barrios-Populares/graficos/graficaPlagasFrecuentes.png", graficaPlagasFrecuentes)
